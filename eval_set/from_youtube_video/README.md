...
These files lived at the **root of `eval_set/`** before the repo was reorganized. They form a **smaller, separate** benchmark (roughly **113** comparable MCQ IDs) built from **California P&C broker-style content aligned to video / transcript study material**, not the Quizlet PDF dump pipeline.
...
**How we got it:** Human- or LLM-authored explanations in the transcript benchmark pipeline.
